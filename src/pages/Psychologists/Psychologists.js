...
import { Button, FourSteps, HugPhone, PersonContent } from "../../components";
...
const Psychologists = () => {
  return (
    <div>
      ...
      <div className="h-[1200px] border"></div>
      <div className=""></div>
      <PersonContent
      ...
      >
        ...
        <p className="text-24">
          Отправьте заявку, пройдите отбор, выберите часы в расписании и начните
          терапию.
        </p>
      </PersonContent>
